...
[link=./utilities/agentic-app-diagram.png]
image::./utilities/agentic-app-diagram.png[Agentic App Diagram showing the architectural components and data flow of the agentic AI application, 800, 600, opts="interactive"]
